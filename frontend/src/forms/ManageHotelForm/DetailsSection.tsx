...
const DetailsSection = () =>{
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className="text-gray-700 text-sm font-bold max-w-[25%]">
                        Price Per Night
            ...
            <label className="text-gray-700 text-sm font-bold max-w-[25%]">
                        Rating
                        <select {...register('startRating', {required: "This field is required"})} className="border rounded w-full p-2 text-gray-800 font-normal">
                        ...
                        {errors.startRating && (
                        <span className="text-red-600">{errors.startRating.message}</span>
                    )}
            </label>
