...
const ImagesSection = ()=>{
    ...
    const handleDelete = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, imageUrl: string) =>{
        ...
        setValue("imageUrls", existingImageUrls.filter((url)=>url !==imageUrl)); //remove the imageurl from the existingimageurl array
    }

    return(
        <div>
            <h2 className="text-sm font-bold mb-3">Images</h2>
